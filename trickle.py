...
def colorWipe(strip, color, wait_ms=50, start=0, end=None):
...
if __name__ == '__main__':
    ...
    try:
        for i in reversed(range(strip.numPixels())):
            ...
            colorWipe(strip, Color(0, 0, 0), 10, start=i, end=strip.numPixels())
        ...
        for i in range(strip.numPixels() - 1):
            ...
            # Turn off all LEDs except the last lit LED
            colorWipe(strip, Color(0, 0, 0), 10, start=0, end=i + 1)
